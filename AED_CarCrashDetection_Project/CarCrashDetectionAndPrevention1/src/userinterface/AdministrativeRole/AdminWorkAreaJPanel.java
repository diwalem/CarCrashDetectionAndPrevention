...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        ...
        if (enterprise.getEnterpriseType().equals(Enterprise.EnterpriseType.SaveLives)) {
            ManageSaveLivesEmployeeJPanel1 manageSaveLivesEmployeeJPanel1 = new ManageSaveLivesEmployeeJPanel1(userProcessContainer, enterprise);
            userProcessContainer.add("manageSaveLivesEmployeeJPanel1", manageSaveLivesEmployeeJPanel1);
