    ...
    private void populateCombo() {
        ...
        if (enterprise.getEnterpriseType().equals(EnterpriseType.Hospital)) {
            ...
            for (Type type : Organization.Type.values()) {
                if (type.getValue().equals(Type.HospitalHelpDesk.getValue())) {
        ...
        if (enterprise.getEnterpriseType().equals(EnterpriseType.SaveLives)) {
        ...
        if (enterprise.getEnterpriseType().equals(EnterpriseType.Police)) {

            for (Type type : Organization.Type.values()) {
                if (type.getValue().equals(Type.PoliceFrontDesk.getValue())) {
                    organizationJComboBox.addItem(type);
                }
