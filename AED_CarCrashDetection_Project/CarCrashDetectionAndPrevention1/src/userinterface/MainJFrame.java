...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private int emergencyBtnCount = 0;

    public MainJFrame() {
        initComponents();

        system = dB4OUtil.retrieveSystem();
        btnEmergency.setIcon(new ImageIcon("C:\\Users\\Mrunalini\\Downloads\\1481509953_BT_c3angle.png"));
        indexList.clear();
    }
    ...
    private void initComponents() {
        ...
        userProcessContainer.add(btnEmergency, "card2");
    ...
    private void btnEmergencyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmergencyActionPerformed
        ...
        if (emergencyBtnCount == 0 || emergencyBtnCount < totalCustomerCount) {
            Configuration config = new Configuration(system);
            emergencyBtnCount++;
            totalCustomerCount = config.RandomEmergency(indexList);
        } else {
            indexList.clear();
            JOptionPane.showMessageDialog(null, "More number of accidents are being created than number of customers registered. ", "Warning", JOptionPane.WARNING_MESSAGE);
        }
